Feature: Economy 7 meter - Recently moved in
  
  - As an unregistered user I want to be able to able to sign up successfully with my Economy 7 meter
  ...
  @ready
  Scenario Outline: User can successfully sign up with a Economy 7 meter  - Dual and Electric
    Given I am a new user type with known postcode "Welcome!","bn126hu","Recently Moved In","Let's go"
    And user has selected an energy type "<Energy Type>"
    And user selects the "Econ meter yes" radio button
    And user selects the "Continue" button
